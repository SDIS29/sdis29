			...
			if(strlen($code_postal) <= 5)
			{
				if($date_fin > $date_debut)
				{
					...
					$sql = "UPDATE formation
							SET
								FCT_ID = '$fonction',
								FOR_LIBELLE = '$intitule',
								FOR_DTE_DEBUT = '$date_debut',
								FOR_DTE_FIN = '$date_fin',
								FOR_CAPACITE = '$capacite',
								FOR_SALLE = '$salle',
								FOR_ADRESSE = '$adresse',
								FOR_CP = '$code_postal',
								FOR_VILLE = '$ville',
					...
					if($req)
					{
						$message = 'La formation a bien &eacute;t&eacute; modifi&eacute;e';
					}
					else
					{
...
$sql1 = "SELECT * FROM formation WHERE FOR_ID='$identifiant'";
    ...
    <div id="left">
		...
		<table cellspacing="15">
			<tr>
				...
				<td>
					<input id="identifiant" name="identifiant" type="text" value="<?php echo $data1['FOR_ID']; ?>" disabled="disabled" />
				</tr>
			<tr>
		        <td>
		        ...
		        <td>
		        	<input id="intitule" name="intitule" type="text" value="<?php echo $data1['FOR_LIBELLE']; ?>"/>
		        </td>
    		</tr>
    		<tr>
		        <td>
		        ...
		        <td>
		        	<input id="date_debut" name="date_debut" type="text" value="<?php echo date("d/m/Y", strtotime($data1['FOR_DTE_DEBUT'])); ?>"/>
		        </td>
    		</tr>
    		<tr>
		        <td>
		        ...
		        <td>
		        	<input id="date_fin" name="date_fin" type="text" value="<?php echo date("d/m/Y", strtotime($data1['FOR_DTE_FIN'])); ?>"/>
		        </td>
    		</tr>
    		<tr>
		        <td>
		        ...
		        <td>
		        	<input id="description" name="description" type="text" value="<?php echo $data1['FOR_DESCRIPTION']; ?>"/>
		        </td>
    		</tr>
		</table>
		...
		<table cellspacing="15">
			...
			<td>
				<input name="envoi_pf71_modification" type="submit" value="Valider"></input> <input type="button" value="Annuler" onclick="window.location.replace('pf71.php')"></input>
        	</td>
    		</tr>
		</table>
    </div>
	...
	<h3>Infos pratiques</h3>
		<table cellspacing="15">
			<tr>
				...
				<td>
					<input id="capacite" name="capacite" type="number" value="<?php echo $data1['FOR_CAPACITE']; ?>"/>
				</tr>
			<tr>
		        <td>
		        ...
		        <td>
		        	<input id="salle" name="salle" type="text" value="<?php echo $data1['FOR_SALLE']; ?>"/>
		        </td>
    		</tr>
    		<tr>
		        <td>
		        ...
		        <td>
		        	<input id="adresse" name="adresse" type="text" value="<?php echo $data1['FOR_ADRESSE']; ?>"/>
		        </td>
    		</tr>
    		<tr>
		        <td>
		        ...
		        <td>
		        	<input id="code_postal" name="code_postal" type="text" value="<?php echo $data1['FOR_CP']; ?>"/>
		        </td>
    		</tr>
    		<tr>
		        <td>
		        ...
		        <td>
		        	<input id="ville" name="ville" type="text" value="<?php echo $data1['FOR_VILLE']; ?>"/>
		        </td>
    		</tr>
    	</table>
		</form>
