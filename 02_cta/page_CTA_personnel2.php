...
<?php
 ...
 <td ><h3> Suppression </h3> </td>
 <td><h3> Modification </h3> </td>
 </tr>
...
while($donnees = mysql_fetch_array($reponse2, MYSQL_BOTH)){
	...
	."</td><td><form id='suppression' action='page_CTA_personnel_suppression.php' method='POST'>
	...
	<td><form id='modification' action='modification.php' method='POST'>
	<input type='hidden' value='".$donnees['2']."' name='matricule'>
	<input type='hidden' value='".$caserne."' name='nomcaserne2'>
 ...
 <?php
echo "<input type='hidden' value='$moipas' name='caserne'></input>";
echo "<input type='hidden' value='$caserne' name='nomcaserne'></input>";
?>
<center>
<input type="submit" id="Ajouter" value=" Ajouter "></input>

<input type="button" id="Annuler" value="Annuler" onclick="window.location.replace('page_CTA_personnel.php')"></input>
</center>
</FORM>
  <div id="right">
